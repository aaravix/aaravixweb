...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <?php include 'commonpage/aboutdata.php'; ?>
</div>
<!-- About End -->
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-5">
                    ...
                    <p class="text-white mb-3">Contact us today to receive a personalized quote for your needs. Our team is here to assist you.</p>
                    <h2 class="text-white mb-0">+91 977 9885 507</h2>
                </div>
            </div>
        </div>
    </div>
...
<!-- Testimonial Start -->
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <?php include 'commonpage/testimonialdata.php'; ?>
</div>
<!-- Testimonial End -->
